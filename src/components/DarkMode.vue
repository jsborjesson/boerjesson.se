<template>
  <button v-if="isDark" @click="lightMode" class="p-1 rounded hover:bg-gray-600">
    <svg class="fill-current text-gray-300 w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  <button v-else @click="darkMode" class="p-1 rounded hover:bg-gray-200">
